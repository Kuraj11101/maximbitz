...
export default function TheStolenValley() {
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-no-repeat bg-cover bg-pagedwn1-pattern bg-[url('/images/kunfupand_4.jpg')]">
            <div className="lg:flex lg:items-center lg:justify-between">
  <div className="min-w-0 flex-1">
    <h2 className="text-2xl font-bold leading-7 text-black-600 sm:truncate sm:text-3xl sm:tracking-tight">Kunfu Panda: 4</h2>
    <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
      ...
      <div className="mt-2 flex items-center text-sm text-gray-500">
        ...
        Number of Downloads &ndash; $140k
      </div>
      <div className="mt-2 flex items-center text-sm text-gray-500">
        <svg className="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
   ...
   <div className="mt-5 flex lg:ml-4 lg:mt-0">
    <span className="sm:block">
      <button type="button" className="inline-flex items-center rounded-md px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
  ...
  <div className="grid grid-cols-3 gap-3 place-items-start text-gray-700">
    <div className="max-w-sm -ml-8 rounded shadow-lg">
      <img className="w-86 h-96"  src="images/kunfupand_4.jpg" alt="Kunfupand_4" />
    </div>
